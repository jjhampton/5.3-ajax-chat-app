...
this["JST"]["message"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<h1>"
    + this.escapeExpression(((helper = (helper = helpers.roomname || (depth0 != null ? depth0.roomname : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0,{"name":"roomname","hash":{},"data":data}) : helper)))
    + " chatroom</h1>\n"
